                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_patient/edit/do_update/'.$row['patient_id'] , array('class' => 'form-horizontal validatable'));?>
	                  <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="phc_id" class="uniform" style="width:100%;">
                                        ...
                                        foreach($phcs as $phc):
                                        ?>
                                            <option value="<?php echo $phc['phc_id'];?>"><?php echo $phc['phc_name'];?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo ('Patient ID');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="pat_id" value="<?php echo isset($row['pat_id']) ? $row['pat_id'] : ''; ?>"/>
                                </div>
                            </div>
                        ...
                        <tr>
							...
							<td><?php echo $row['blood_group'];?></td>
							 <td align="center">
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_patient/edit/<?php echo $row['pat_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_patient/delete/<?php echo $row['pat_id'];?>" onclick="return confirm('delete?')"
