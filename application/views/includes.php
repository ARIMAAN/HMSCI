...
$system_name = $this->db->get_where('settings', array('type' => 'system_name'))->row()->description ?? 'Default System Name';
$system_title = $this->db->get_where('settings', array('type' => 'system_title'))->row()->description ?? 'Default System Title';

// Ensure fallback values are provided if 'description' is not accessible
?>